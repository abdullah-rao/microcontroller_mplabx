...
#pragma config   FPLLODIV  = DIV_4  // PLL	 Out 8mHz/2= 40	 mHzsystem frequency osc	
...
int global_delay_val = (16501.3);        // vary this to change the pulse's delay.
...
//	
  ...
  off	
  Analogue	
  f		// Set all pins on PORT A to output
